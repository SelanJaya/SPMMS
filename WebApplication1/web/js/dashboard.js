...
//            case "PROJECT_JOIN":
//            case "TASK_ASSIGN": // Combining similar positive actions
//                iconMarkup = `<i class="bi bi-person-plus-fill text-success" style="font-size: 0.8rem;"></i>`;
//                iconBg = "bg-success-subtle";
//                break;
//
//            case "PROJECT_REMOVE":
//            case "TASK_REMOVE":
//                iconMarkup = `<i class="bi bi-person-dash-fill text-danger" style="font-size: 0.8rem;"></i>`;
//                iconBg = "bg-danger-subtle";
//                break;
//        }
//
//        container.innerHTML += `
//            <div class="d-flex justify-content-between align-items-center mb-3 pb-3 px-3 border-bottom">
//
//                <div class="d-flex align-items-center">
//                    <!-- New Icon Wrapper instead of the dot -->
//                    <div class="me-3 d-flex justify-content-center align-items-center rounded-circle ${iconBg}"
...
//
//        // Unique ID for the collapse targeting
//        const uniqueCollapseId = `devRemoveDetails_${activity.assignmentId || index}`;
//
//        switch (activity.activityType) {
//            case "PROJECT_JOIN":
//            case "TASK_ASSIGN": // Combining similar positive actions
...
//                
//                // 2. Add the down arrow icon
//                chevronIcon = `<i class="bi bi-chevron-down text-muted" style="font-size: 0.7rem;"></i>`;
//
//                // 3. Build the expanded box (Notice: NO Edit Button here for devs!)
//                extraDetailsHtml = `
//                    <div class="collapse mt-2" id="${uniqueCollapseId}">
//                        <div class="bg-light p-2 rounded border border-light" style="font-size: 0.75rem; margin-left: 44px;">
...
//                
//                <div class="d-flex justify-content-between align-items-center" ${toggleAttributes}>
//                    
//                    <div class="d-flex align-items-center">
//                        <div class="me-3 d-flex justify-content-center align-items-center rounded-circle ${iconBg}"
//                             style="width: 28px; height: 28px;">
...
function populateRecentActivity_Dev(activities) {
    ...
    activities.forEach((activity, index) => {
        ...
        switch (activity.activityType) {
            ...
            case "PROJECT_REMOVE":
            case "TASK_REMOVE":
                // Swapped to FontAwesome User-Minus
                iconMarkup = `<i class="fas fa-user-minus text-danger" style="font-size: 0.8rem;"></i>`;
                iconBg = "bg-danger-subtle";
                ...
                // 3. Build the expanded box WITH the "View" button
                extraDetailsHtml = `
                    <div class="collapse mt-2" id="${uniqueCollapseId}">
        ...
        container.innerHTML += `
            <div class="mb-3 pb-3 px-1 border-bottom">
...
function populateRecentActivity(activities) {
    ...
    activities.forEach((activity, index) => {
        ...
        // Create a unique ID for the collapse box so they don't all open at once
        // Using assignmentId if it exists, otherwise fallback to the loop index
        const uniqueCollapseId = `removeDetails_${activity.assignmentId || index}`;

        switch (activity.activityType) {
            case "PROJECT_JOIN":
            case "TASK_ASSIGN":
                iconMarkup = `<i class="fas fa-user-plus text-success" style="font-size: 0.8rem;"></i>`;
                iconBg = "bg-success-subtle"; // Optional: Use standard bg-success if you don't have Bootstrap subtle colors
                break;

            case "PROJECT_REMOVE":
            case "TASK_REMOVE":
                iconMarkup = `<i class="fas fa-user-minus text-danger" style="font-size: 0.8rem;"></i>`;
                iconBg = "bg-danger-subtle"; // Optional: Use standard bg-danger here
                ...
                // Build the hidden expanding box (and put your Edit button inside it!)
                extraDetailsHtml = `
                    <div class="collapse mt-2" id="${uniqueCollapseId}">
                        <div class="bg-light p-2 rounded border border-light d-flex justify-content-between align-items-center" style="font-size: 0.75rem; margin-left: 36px;">
                            <div>
        ...
        // 2. Build the final HTML for the item
        container.innerHTML += `
            <div class="mb-3 pb-3 border-bottom px-1">
                
                <div class="d-flex justify-content-between align-items-center" ${toggleAttributes}>
                    
                    <div class="d-flex align-items-center">
                        <div class="me-3 d-flex justify-content-center align-items-center rounded-circle ${iconBg}" style="width: 28px; height: 28px;">
                            ${iconMarkup}
                        </div>
