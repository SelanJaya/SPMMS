...
public class login_signUpServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String pagatype, username, phone_number, email, role, password, confirmPassword;
        boolean status;

        PrintWriter out = response.getWriter();

        pagatype = request.getParameter("pageType");

        if (pagatype.equalsIgnoreCase("login")) {
        ...
        } else if (pagatype.equalsIgnoreCase("signUp")) {
